-- BudgetCasa Pro Database Setup - Step 3 (Sample Data) - FIXED VERSION
-- Run this AFTER Step 1 and Step 2 complete successfully

-- Seed ATECO taxonomy (sample entries) - Fixed apostrophes
insert into industry_taxonomy (code, label, level) values
  ...
  ('62', 'Produzione di software, consulenza informatica e attivita connesse', 2),
  ('62.01', 'Produzione di software non connesso alla edizione', 3),
  ('62.02', 'Consulenza nel settore delle tecnologie della informatica', 3),
  ('K', 'Attivita finanziarie e assicurative', 1),
  ...
  ('M', 'Attivita professionali, scientifiche e tecniche', 1),
  ('69', 'Attivita legali e contabilita', 2),
  ('70', 'Attivita di direzione aziendale e di consulenza gestionale', 2)
...
insert into lead_person_scores (lead_id, risk_home, risk_mobility, opportunity_life, opportunity_home, explanation) values
  ('22222222-2222-2222-2222-222222222221', 0.72, 0.65, 0.68, 0.82, '{"home": "Area urbana ad alta densita", "mobility": "Uso misto auto/bici", "life": "Famiglia con figli"}'),
  ...
  ('22222222-2222-2222-2222-222222222225', 0.61, 0.38, 0.71, 0.69, '{"home": "Coppia eco-conscious", "mobility": "Mobilita sostenibile", "life": "Professionisti"}'),
  ('22222222-2222-2222-2222-222222222226', 0.66, 0.58, 0.74, 0.71, '{"home": "Famiglia culturale", "mobility": "Mobilita mista", "life": "Interesse cultura"}'),
...
insert into company_scores (company_id, risk_flood, risk_crime, risk_business_continuity, opportunity_employee_benefits, opportunity_property, explanation) values
  ...
  ('33333333-3333-3333-3333-333333333336', 0.39, 0.33, 0.69, 0.65, 0.58, '{"flood": "Firenze, rischio medio", "crime": "Centro citta", "continuity": "Startup volatilita", "benefits": "Team piccolo", "property": "Ufficio in affitto"}'),
